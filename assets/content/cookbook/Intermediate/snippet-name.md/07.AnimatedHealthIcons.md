...
The health icon has 5 types of animation prefixes.
...
After editing the XML as per the prefixes given above, the icon will start playing it's animation in the game.
